...
let #Even tau
    ...
    p2=plot(datatau2s.a, datatau2s.N1, color="#73D055FF", label="\$\\tau\$=2.0")
    plot!(datatau2ua.a[20:end], datatau2ua.N1[20:end], color="#73D055FF", linestyle=:dash, lw=1.5, label="")
    ...
    plot!(datatau6s.a, datatau6s.N1, color="#404788FF", label="\$\\tau\$=6.0")
    plot!(maxmindata2.a, maxmindata2.maximum, color="#73D055FF", linestyle=:dashdotdot, lw=2, label="")
    plot!(maxmindata2.a, maxmindata2.minimum, color="#73D055FF", linestyle=:dashdotdot,lw=2, label="")
    plot!(maxmindata4.a, maxmindata4.maximum, color="#1F968BFF", linestyle=:dashdotdot,lw=2, label="")
    plot!(maxmindata4.a, maxmindata4.minimum, color="#1F968BFF", linestyle=:dashdotdot,lw=2, label="")
    ...
    p3=plot(datatau6s.a, datatau6s.N1, color="#404788FF", label="\$\\tau\$=6.0")
    ...
    scatter!([31.75],[-0.5],color=:black,marker=:star5,ms=8,label="")
    scatter!([33.25],[-0.5],color=:black,ms=5,label="")
    xlabel!("a")
    ylims!(-0.77, 20.0)
    xlims!(30.0, 36.0)
    xticks!([30, 32, 34, 36])
...
let #tau=3 (odd)
    ...
    scatter!([10.90],[-0.5],color=:black,marker=:star5,ms=8,label="")
    scatter!([11.06],[-0.5],color=:black,ms=5,label="")
...
let #tau=5 (odd)
    ...
    scatter!([20.35],[-0.5],color=:black,marker=:star5,ms=8,label="")
    scatter!([20.75],[-0.5],color=:black,ms=5,label="")
    xlabel!("a")
...
let #2 parameter (a & p) bifurcation diagram of Ricker Constant 
    ...
    plot(bp_datatau1.a, bp_datatau1.Low2ndpar, lw=2, linestyle=:solid, color="#FDE725FF", label="\$\\tau\$=1")
    plot!(hp_datatau1.a, hp_datatau1.Low2ndpar, lw=2, linestyle=:dash, color="#FDE725FF", label="")
    plot!(bp_datatau2.a, bp_datatau2.Low2ndpar, lw=2, linestyle=:solid, color="#73D055FF", label="\$\\tau\$=2")
    plot!(hp_datatau2.a, hp_datatau2.Low2ndpar, lw=2, linestyle=:dash, color="#73D055FF", label="")
    plot!(bp_datatau3.a, bp_datatau3.Low2ndpar, lw=2, linestyle=:solid, color="#20A387FF", label="\$\\tau\$=3")
    plot!(hp_datatau3.a, hp_datatau3.Low2ndpar, lw=2, linestyle=:dash, color="#20A387FF", label="")
    plot!(bp_datatau4.a, bp_datatau4.Low2ndpar, lw=2, linestyle=:solid, color="#2D708EFF", label="\$\\tau\$=4")
    plot!(hp_datatau4.a, hp_datatau4.Low2ndpar, lw=2, linestyle=:dash, color="#2D708EFF", label="")
    plot!(bp_datatau8.a, bp_datatau8.Low2ndpar, lw=2, linestyle=:solid, color="#453781FF", label="\$\\tau\$=8")
...
let 
    ...
    p1 = scatter(RCorbitdata1[1], log10.(RCorbitdata1[2] .+1), color=:black, ms=6,label="")
    scatter!([1.0], [0.0], color=:black, ms=6, label="")
    xlabel!("\$\\tau\$")
    ylabel!("\$\\log_{10}(N+1)\$")
    xticks!([0, 2, 4, 6, 8])
    xlims!(0.0, 8.5)
    p2 = scatter(RCorbitdata2[1], RCorbitdata2[2], color=:black, ms=6, label="")
    scatter!([1.0], [0.0], color=:black, ms=6,label="")
    xlabel!("\$\\tau\$")
    ylabel!("N")
    xlims!(0.0, 8.5)
    xticks!([0, 2, 4, 6, 8])
    plot(p1, p2, layout = (2,1), size = (400, 500), left_margin=2mm)
    savefig(joinpath(abpath(), "figs/RickerConstant_tauorbit.pdf"))
end
