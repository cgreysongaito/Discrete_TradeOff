...
let
    ...
    xlabel!("a")
    ylabel!("C")
    annotate!([-10],[0.75],("a)", 18, "Computer Modern"))
    plot!(left_margin=12mm,legend=false)
    ...
    xlabel!("a")
    ylabel!("β")
    annotate!([-10],[0.75],("b)", 18, "Computer Modern"))
    plot!(left_margin=12mm,legend=:outerright)
