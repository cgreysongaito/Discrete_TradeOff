...
let 
    ...
    p2 = scatter(RCorbitdata[1], log10.(RCorbitdata[2] .+1), color=:black, ms=6,label="")
...
let
    ...
    dataN = timeseries[end-50:end]
    p2 = scatter(RCorbitdata[1], RCorbitdata[2], color=:black, ms=6, label="")
    scatter!([1.0], [0.0], color=:black, ms=6,label="")
    xlabel!("τ")
    ylabel!("N")
    xlims!(0.0, 8.5)
...
let
    ...
    p1=plot(bp_datatau1C.a, bp_datatau1C.Low2ndpar, lw=2, linestyle=:solid, color="#FDE725FF", label="τ=1")
    plot!(hp_datatau1C.a, hp_datatau1C.Low2ndpar, lw=2, linestyle=:dash, color="#FDE725FF", label="")
    plot!(bp_datatau2C.a, bp_datatau2C.Low2ndpar, lw=2, linestyle=:solid, color="#73D055FF", label="τ=2")
    plot!(hp_datatau2C.a, hp_datatau2C.Low2ndpar, lw=2, linestyle=:dash, color="#73D055FF", label="")
    plot!(bp_datatau3C.a, bp_datatau3C.Low2ndpar, lw=2, linestyle=:solid, color="#20A387FF", label="τ=3")
    plot!(hp_datatau3C.a, hp_datatau3C.Low2ndpar, lw=2, linestyle=:dash, color="#20A387FF", label="")
    plot!(bp_datatau4C.a, bp_datatau4C.Low2ndpar, lw=2, linestyle=:solid, color="#2D708EFF", label="τ=4")
    plot!(hp_datatau4C.a, hp_datatau4C.Low2ndpar, lw=2, linestyle=:dash, color="#2D708EFF", label="")
    plot!(bp_datatau5C.a, bp_datatau5C.Low2ndpar, lw=2, linestyle=:solid, color="#453781FF", label="τ=5")
    plot!(hp_datatau5C.a, hp_datatau5C.Low2ndpar, lw=2, linestyle=:dash, color="#453781FF", label="")
    plot!(bp_datatau9C.a, bp_datatau9C.Low2ndpar, lw=2, linestyle=:solid, color="#440154FF", label="τ=9")
    plot!(hp_datatau9C.a, hp_datatau9C.Low2ndpar, lw=2, linestyle=:dash, color="#440154FF", label="")
    scatter!([26.5], [0.5], color=:black, marker=:star5, ms=12, label="")
    ...
    xlabel!("a")
    ylabel!("C")
    p2=plot(bp_datatau1β.a, bp_datatau1β.Low2ndpar, lw=2, linestyle=:solid, color="#FDE725FF", label="τ=1")
    plot!(hp_datatau1β.a, hp_datatau1β.Low2ndpar, lw=2, linestyle=:dash, color="#FDE725FF", label="")
    plot!(bp_datatau2β.a, bp_datatau2β.Low2ndpar, lw=2, linestyle=:solid, color="#73D055FF", label="τ=2")
    plot!(hp_datatau2β.a, hp_datatau2β.Low2ndpar, lw=2, linestyle=:dash, color="#73D055FF", label="")
    plot!(bp_datatau3β.a, bp_datatau3β.Low2ndpar, lw=2, linestyle=:solid, color="#20A387FF", label="τ=3")
    plot!(hp_datatau3β.a, hp_datatau3β.Low2ndpar, lw=2, linestyle=:dash, color="#20A387FF", label="")
    plot!(bp_datatau4β.a, bp_datatau4β.Low2ndpar, lw=2, linestyle=:solid, color="#2D708EFF", label="τ=4")
    plot!(hp_datatau4β.a, hp_datatau4β.Low2ndpar, lw=2, linestyle=:dash, color="#2D708EFF", label="")
    plot!(bp_datatau5β.a, bp_datatau5β.Low2ndpar, lw=2, linestyle=:solid, color="#453781FF", label="τ=5")
    plot!(hp_datatau5β.a, hp_datatau5β.Low2ndpar, lw=2, linestyle=:dash, color="#453781FF", label="")
    plot!(bp_datatau9β.a, bp_datatau9β.Low2ndpar, lw=2, linestyle=:solid, color="#440154FF", label="τ=9")
