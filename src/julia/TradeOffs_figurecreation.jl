...
let #2 parameter (a & p) bifurcation diagram of Ricker Constant 
    ...
    p2=scatter(RCorbitdata1[1], log10.(RCorbitdata1[2] .+1), color=:black, ms=4,label="")
    scatter!([1.0], [0.0], color=:black, ms=4, label="")
    xlabel!("\$\\tau\$")
    ylabel!("\$\\log_{10}(N+1)\$")
    xticks!([0, 2, 4, 6, 8])
    xlims!(0.0, 8.5)
    annotate!([-4],[3.9],("b)", 18, "Computer Modern"))

    p3 = scatter(RCorbitdata2[1], RCorbitdata2[2], color=:black, ms=4, label="")
    scatter!([1.0], [0.0], color=:black, ms=4,label="")
    xlabel!("\$\\tau\$")
    ylabel!("N")
    xlims!(0.0, 8.5)
    xticks!([0, 2, 4, 6, 8])
    annotate!([-4],[0.18],("c)", 18, "Computer Modern"))
    plot(
        p1, p2,p3,
        # plot(p2, p3, layout = (2, 1)), 
        layout = @layout[a{0.8w} [grid(2,1)
            ]], 
        size = (1200, 400), 
        left_margin = 2mm
    )
...
let
    ...
    p1=plot(bp_datatau1C.a, bp_datatau1C.Low2ndpar, lw=2, linestyle=:solid, color="#FDE725FF", label="\$\\tau\$=1")
    plot!(hp_datatau1C.a, hp_datatau1C.Low2ndpar, lw=2, linestyle=:dash, color="#FDE725FF", label="")
    plot!(bp_datatau2C.a, bp_datatau2C.Low2ndpar, lw=2, linestyle=:solid, color="#73D055FF", label="\$\\tau\$=2")
    plot!(hp_datatau2C.a, hp_datatau2C.Low2ndpar, lw=2, linestyle=:dash, color="#73D055FF", label="")
    plot!(bp_datatau3C.a, bp_datatau3C.Low2ndpar, lw=2, linestyle=:solid, color="#20A387FF", label="\$\\tau\$=3")
    plot!(hp_datatau3C.a, hp_datatau3C.Low2ndpar, lw=2, linestyle=:dash, color="#20A387FF", label="")
    plot!(bp_datatau4C.a, bp_datatau4C.Low2ndpar, lw=2, linestyle=:solid, color="#2D708EFF", label="\$\\tau\$=4")
    plot!(hp_datatau4C.a, hp_datatau4C.Low2ndpar, lw=2, linestyle=:dash, color="#2D708EFF", label="")
    plot!(bp_datatau5C.a, bp_datatau5C.Low2ndpar, lw=2, linestyle=:solid, color="#453781FF", label="\$\\tau\$=5")
    plot!(hp_datatau5C.a, hp_datatau5C.Low2ndpar, lw=2, linestyle=:dash, color="#453781FF", label="")
    plot!(bp_datatau9C.a, bp_datatau9C.Low2ndpar, lw=2, linestyle=:solid, color="#440154FF", label="\$\\tau\$=9")
    plot!(hp_datatau9C.a, hp_datatau9C.Low2ndpar, lw=2, linestyle=:dash, color="#440154FF", label="")
    ...
    p2=plot(bp_datatau1β.a, bp_datatau1β.Low2ndpar, lw=2, linestyle=:solid, color="#FDE725FF", label="\$\\tau\$=1")
    plot!(hp_datatau1β.a, hp_datatau1β.Low2ndpar, lw=2, linestyle=:dash, color="#FDE725FF", label="")
    plot!(bp_datatau2β.a, bp_datatau2β.Low2ndpar, lw=2, linestyle=:solid, color="#73D055FF", label="\$\\tau\$=2")
    plot!(hp_datatau2β.a, hp_datatau2β.Low2ndpar, lw=2, linestyle=:dash, color="#73D055FF", label="")
    plot!(bp_datatau3β.a, bp_datatau3β.Low2ndpar, lw=2, linestyle=:solid, color="#20A387FF", label="\$\\tau\$=3")
    plot!(hp_datatau3β.a, hp_datatau3β.Low2ndpar, lw=2, linestyle=:dash, color="#20A387FF", label="")
    plot!(bp_datatau4β.a, bp_datatau4β.Low2ndpar, lw=2, linestyle=:solid, color="#2D708EFF", label="\$\\tau\$=4")
    plot!(hp_datatau4β.a, hp_datatau4β.Low2ndpar, lw=2, linestyle=:dash, color="#2D708EFF", label="")
    plot!(bp_datatau5β.a, bp_datatau5β.Low2ndpar, lw=2, linestyle=:solid, color="#453781FF", label="\$\\tau\$=5")
    plot!(hp_datatau5β.a, hp_datatau5β.Low2ndpar, lw=2, linestyle=:dash, color="#453781FF", label="")
    plot!(bp_datatau9β.a, bp_datatau9β.Low2ndpar, lw=2, linestyle=:solid, color="#440154FF", label="\$\\tau\$=9")
    plot!(hp_datatau9β.a, hp_datatau9β.Low2ndpar, lw=2, linestyle=:dash, color="#440154FF", label="")
    scatter!([26.5], [0.5], color=:black, marker=:star5, ms=10, label="")
    scatter!([26.5], [0.1], color=:black, marker=:square, ms=6, label="")
    scatter!([26.5], [0.3], color=:black, marker=:diamond, ms=8, label="")
    ...
    xlabel!("a")
    ylabel!("β")
    plot!(legend=:outerright,left_margin=4mm)
    plot(p1, p2, layout=@layout([a{0.42w} b{0.58w}]), size=(1000, 300),bottom_margin=8mm)
...
let 
    ...
    title!("C=β")
    xlims!(0.0, 35.5)
    plot(p1, p3,p5,p2,p4, size=(800, 600), layout=(2, 3), legend=:none)
