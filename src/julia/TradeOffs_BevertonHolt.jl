...
let 
    ...
    βval01data=NdataBHBH_β(τrange, 0.1, BevHoltPar(α=0.1,C=0.3,D=0.1,a=5.0,b=200.0,K=1.0))
    βval05data=NdataBHBH_β(τrange, 0.5, BevHoltPar(α=0.1,C=0.3,D=0.1,a=5.0,b=200.0,K=1.0))
    βval10data=NdataBHBH_β(τrange, 1.0, BevHoltPar(α=0.1,C=0.3,D=0.1,a=5.0,b=200.0,K=1.0))
